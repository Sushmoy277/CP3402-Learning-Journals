...
This week I focused on setting up all the teamwork tools required for our group project. I connected with my teammates on LinkedIn and joined our Slack channel to communicate with the team. We used Slack to share updates, discuss ideas, and stay organised.
...
Additionally, we integrated GitHub and Trello with Slack. This allowed updates like commits and task changes to appear automatically in Slack, making communication faster and more efficient.
...
- Slack improves communication and keeps everyone updated  
- Integrating tools (GitHub + Trello + Slack/Discord) creates a smooth and efficient workflow  
...
Communication through Slack also showed me how important clear and consistent communication is. I noticed that when team members share updates regularly, it reduces confusion and helps everyone stay on the same page. In a professional environment, this is a critical skill.
